  ...
  return (
    ...
    <section className="hero">
      <div className="hero-intro">
        ...
        <p> All things are possible with a cat on your lap,<br/> coffee in your mug and code on your laptop. </p>
      </div>
    </section>
      ...
      <div className="about-section">
        <div className="about-text">
          <h2>About</h2>
            ...
            I am dedicated to staying up to date with the latest trends and technologies in website design and committed to bringing state-of-the-art web approaches.
        ...
        <ul>
          ...
          <li>Cats are my spirit animals, I was a crazy cat lady as early as middle school. Currently I have 3, but I think we need one more!
          </li>
          <li>The web has always been a part of my life. As a child, I recall going on photo shoots with my mom for the sites she was building. In high school, I studied interactive media and was a part of the website club that created the first website for our high school.
</li>
        </ul>
      </div>
        <br/>
